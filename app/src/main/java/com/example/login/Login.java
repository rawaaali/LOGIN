...
public class Login extends Fragment {
    ...
    public void onStart() {
        ...
        tvForgotpassword=getView().findViewById(R.id.etEmailForfgotpassword);
    ...
    private void gotoSignupFragment() {
        ...
        ft . replace(R.id.frameLayoutMain,new Singup())  ;
        ft . commit();
    }
    private void gotoForgotPasswordFragment(){
        FragmentTransaction ft= getActivity().getSupportFragmentManager().beginTransaction();
        ft.replace(R.id.frameLayoutMain,new forgot_password());
        ft.commit();
    }
}